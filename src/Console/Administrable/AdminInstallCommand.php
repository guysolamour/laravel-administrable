...
class AdminInstallCommand extends BaseCommand
{
    ...
    protected function loadCrudConfiguration()
    {
        ...
        // save route callback syntax in config file
        // verifier si true ou false
    ...
    protected function loadRoutes()
    {
        ...
        // Front routes;
        $route_stub = $this->getFilesFromDirectory(self::TPL_PATH . "/routes/web/front/${prefix}", false);
        ...
        // Back routes;
        $route_stub = $this->getFilesFromDirectory(self::TPL_PATH . "/routes/web/back/${prefix}", false);
