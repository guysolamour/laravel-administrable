...
@section('title', __('administrable::messages.view.configuration.plural'))
...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>{{ __('administrable::messages.view.configuration.plural') }}</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">{{ __('administrable::messages.view.configuration.plural') }}</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
    ...
    <div class="card">
      <div class="card-header">
        <div class="card-tools">
          <button type="button" class="btn btn-tool" data-card-widget="collapse" data-toggle="tooltip" title="{{ __('administrable::messages.default.minus') }}">
                 ...
                 <div class="col-md-12">
                  <div class="form-group">
                    <button class="btn btn-primary btn-block" type="submit"><i class="fa fa-edit"></i>
                      {{ __('administrable::messages.default.save') }}</button>
                  </div>
                </div>
                {!! form_end($form) !!}
          </div>
