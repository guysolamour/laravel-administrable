                            ...
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div class="btn-group">
                                    <a href="{{ back_route('extensions.testimonial.testimonial.create') }}" class="btn btn-success">
                                        <i class="fa fa-plus"></i>&nbsp; {{ Lang::get('administrable::messages.default.add') }}
                                    </a>

                                    <a href="#" class="btn btn-danger d-none" data-model="{{ AdminModule::model('testimonial') }}" id="delete-all">
                                        <i class="fa fa-trash"></i>
                                        {{ Lang::get("administrable::messages.default.deleteall") }}
                                    </a>
                                </div>
                            </div>
                            <!-- /.card-header -->
