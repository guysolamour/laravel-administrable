...
<form action="{{ back_route('extensions.shop.command.update', $command) }}" method="post" x-data="Command">
    @method('PUT')
    @else
    <form action="{{ back_route('extensions.shop.command.store') }}" method="post" x-data="Command">
        @endif
        @csrf
        <div class="row">
            <div class="col-md-9 ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div x-show="apply_discount" class="clearfix">
                                            <input type="text" class="form-control" placeholder="Entrez le montant de la remise" x-model="form.discount">
                                            <div class="btn-group mt-2 mb-2 float-right">
                                                <button @click.prevent="apply_discount = false" class="btn btn-secondary btn-sm">Annuler</button>
                                                <button @click.prevent="applyDiscount" class="btn btn-primary btn-sm">Appliquer la remise</button>
                                            </div>
                                        </div>
