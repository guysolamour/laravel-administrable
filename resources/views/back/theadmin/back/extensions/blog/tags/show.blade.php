...
<div class="main-content">
    ...
    <div class="fab fab-fixed">
        ...
        <ul class="fab-buttons">
            ...
            <li><a class="btn btn-float btn-sm btn-danger" href="{{ back_route('extensions.blog.tag.destroy',$tag) }}" data-method="delete" data-confirm="Etes vous sur de bien vouloir procéder à la suppression ?"   data-provide="tooltip"
