...
<div class="main-content">
            ...
            <div class="card-title flexbox">
                ...
                <div>
                    ...
                    <div class="collapse no-collapsing cursor-text" id="email-info-2">
                        <small class="d-inline-block w-40px mt-1">{{ Lang::get('administrable::extensions.mailbox.view.from') }}:</small>
    ...
    <div class="card">
        <div class="card-header ml-4">
            <h3 class="card-title font-weight-bold"><i class="fa fa-comments"></i> {{ Lang::get('administrable::extensions.mailbox.view.notes') }}</h3>
        </div>
        <div class="card-body">
    ...
    <div class="fab fab-fixed">
        ...
        <ul class="fab-buttons">
            ...
            data-confirm="{{ Lang::get('administrable::extensions.mailbox.view.destroy') }}" title="{{ Lang::get('administrable::messages.default.delete') }}" data-provide="tooltip"
